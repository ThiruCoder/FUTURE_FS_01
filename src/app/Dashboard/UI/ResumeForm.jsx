...
const ResumeForm = ({ open, handleClose, style, setRefresh, updatedId, setOpen, setUpdatedId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(cleanedFormData); // ✅ This will show the updated values
        ...
        try {
            ...
            await AxiosInstance[method](endpoint, cleanedFormData)
                .then((res) => {
                    resetForm();
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            try {
                const response = await AxiosInstance.get(`/resume/getResumeById/${updatedId}`);
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid size={{ xs: 12, md: 4 }} sx={{ mt: 2 }}>
                                    {/* <Autocomplete
                                        multiple
                                        freeSolo
                                        options={skillTags.filter((tag) => !(formData?.skills || []).includes(tag))}
                                ...
                                <Grid size={{ xs: 12, md: 1 }} sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                                    <Button
                                        variant="contained"
